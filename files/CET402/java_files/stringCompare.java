public class stringCompare {
    ...
    public static void main(String[] args) {
        ...
        // We can force a string to have only upper or lower case characters using these
        // methods
        System.out.println(one.toUpperCase());
        System.out.println(one.toLowerCase());

        // Now your turn. Compare the two strings declared below without regard to case.
