public class Substrings {
    ...
    public static void main(String[] args) {
        ...
        // a single parameter can be passed to the method indicated the first character
        // to use from the string
        ...
        // print the part of the string above that says "Devils!" using the substring
        // method

        // print the part of the string above that says "Blue Devils" using the
        // substring method

        // Pick your favorite color (other than blue) and rewrite the sentence to change
        // to color of the mascot using the substring method
