public class FunWithStrings {
	...
	public static void main(String[] args) {
		...
		// We can improve the appearance of the greeting by adding (called
		// concatenating) characters where needed
		System.out.print(greeting + " ");
		System.out.print(firstName + " ");
		System.out.println(lastName + "!");

		// Some methods can return information about the data in an object
		// length() is a method of String object that returns the number of characters
		// in the String data
		int charCount = 0;
		charCount = firstName.length();
		System.out.println("Your first name has " + charCount + " characters.");

		// Write code here that prints the total number of characters in your whole name
		// (first and last)

		// Declare another string that contains your middle name (if you don't have one,
		// make one up)
