...
public class UsingScanner {
	public static void main(String[] args) {
		...
		//Run the code multiple times and enter different types of values (int, doubles, Strings) 
		...
		//The values read from the scanner object can be stored in variables for latter use 
